<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
            ...
            <form class="form_group">
              <div class="form_radio_group">
                <div class="form_radio_group-item">
                  <input type="checkbox" name="x" id="xr1" value="-2" />
                  <label for="xr1" class="material-label">-2</label>
                </div>
                <div class="form_radio_group-item">
                  <input type="checkbox" name="x" id="xr2" value="-1.5" />
                  <label for="xr2" class="material-label">-1.5</label>
                </div>
                <div class="form_radio_group-item">
                  <input type="checkbox" name="x" id="xr3" value="-1" />
                  <label for="xr3" class="material-label">-1</label>
                </div>
                <div class="form_radio_group-item">
                  <input type="checkbox" name="x" id="xr4" value="-0.5" />
                  <label for="xr4" class="material-label">-0.5</label>
                </div>
                <div class="form_radio_group-item">
                  <input type="checkbox" name="x" id="xr5" value="0" />
                  <label for="xr5" class="material-label">0</label>
                </div>
                <div class="form_radio_group-item">
                  <input type="checkbox" name="x" id="xr6" value="0.5" />
                  <label for="xr6" class="material-label">0.5</label>
                </div>
                <div class="form_radio_group-item">
                  <input type="checkbox" name="x" id="xr7" value="1" />
                  <label for="xr7" class="material-label">1</label>
                </div>
                <div class="form_radio_group-item">
                  <input type="checkbox" name="x" id="xr8" value="1.5" />
                  <label for="xr8" class="material-label">1.5</label>
                </div>
                <div class="form_radio_group-item">
                  <input type="checkbox" name="x" id="xr9" value="2" />
              ...
              <div class="form_radio_group" id="r-value-picker">
                <div class="form_radio_group-item">
                  <input type="checkbox" name="r" id="rr1" value="1" />
                  <label for="rr1" class="material-label">1</label>
                </div>
                <div class="form_radio_group-item">
                  <input type="checkbox" name="r" id="rr2" value="1.5" />
                  <label for="rr2" class="material-label">1.5</label>
                </div>
                <div class="form_radio_group-item">
                  <input type="checkbox" name="r" id="rr3" value="2" />
                  <label for="rr3" class="material-label">2</label>
                </div>
                <div class="form_radio_group-item">
                  <input type="checkbox" name="r" id="rr4" value="2.5" />
                  <label for="rr4" class="material-label">2.5</label>
                </div>
                <div class="form_radio_group-item">
                  <input type="checkbox" name="r" id="rr5" value="3" />
                  <label for="rr5" class="material-label">3</label>
                </div>
              </div>
              <div>
                <button class="spongebob-button" type="submit">Krusty Krab time!</button>
                <button id="clear-table-button" onclick="clearTable()" class="spongebob-button" style="margin: 30px"
                  type="button">
                  Yeet the Table!
                </button>
              </div>
  ...
  <script type="text/javascript">
    function uncheckOtherCheckboxes(groupName, checkbox) {
    ...
    var checkboxesX = document.getElementsByName('x');
    var checkboxesR = document.getElementsByName('r');

    checkboxesX.forEach(function (checkbox) {
      checkbox.addEventListener('change', function () {
        uncheckOtherCheckboxes('x', checkbox);
      });
    });

    checkboxesR.forEach(function (checkbox) {
      checkbox.addEventListener('change', function () {
        uncheckOtherCheckboxes('r', checkbox);
        redrawGraph('R');
      });
    });
  </script>
