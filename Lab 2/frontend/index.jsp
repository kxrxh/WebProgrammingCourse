...
<body>
    <table>
        <tr>
            <header id="appbar">
                <h2 id="app-name" onclick="playTheme()">Sponge work #1</h2>
                <div>
                ...
                <div class="app-body">
                    ...
                    <form class="form_group">
                        ...
                        <div style="margin-bottom: 20px">
                            <input type="text" value="0" name="y" pattern="^-?([0-2](\.\d+)?|3(\.0+)?)$"
                                class="text-input" required min="-3" max="3" placeholder="-3...3" />
                        </div>
                        ...
                        <div class="form_radio_group" id="r-value-picker">
                            ...
                            <div class="form_radio_group-item">
                                <input type="radio" name="r" id="rr2" value="2" />
                                <label for="rr2" class="material-label">2</label>
                            </div>
                            <div class="form_radio_group-item">
                                <input type="radio" name="r" id="rr3" value="3" />
                                <label for="rr3" class="material-label">3</label>
                            </div>
                            <div class="form_radio_group-item">
                                <input type="radio" name="r" id="rr4" value="4" />
                                <label for="rr4" class="material-label">4</label>
                            </div>
                            <div class="form_radio_group-item">
                                <input type="radio" name="r" id="rr5" value="5" />
                                <label for="rr5" class="material-label">5</label>
                            </div>
                        </div>
                        <div>
                            <button class="spongebob-button" type="submit">Krusty Krab time!</button>
                            <button id="clear-table-button" class="spongebob-button" style="margin: 30px"
                                type="button">Yeet the Table!</button>
                        </div>
                    </form>
                </div>
            </td>
